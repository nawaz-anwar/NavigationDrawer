...
import com.coetusstudio.navigationdrawer.models.NoticeData;
...
public class SendnotificationActivity extends AppCompatActivity {
    ...
    private <storageReference> void uploadImage() {
        ...
        uploadTask.addOnCompleteListener(SendnotificationActivity.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
    ...
    private void uploadData() {
        ...
        reference.child(uniqueKey).setValue(noticeData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                pd.dismiss();
                Toast.makeText(SendnotificationActivity.this, "Notice Uploaded", Toast.LENGTH_SHORT).show();
